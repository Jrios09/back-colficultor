...
class Settings(BaseSettings):
    ...
    BACKEND_CORS_ORIGINS: list[str] = ["http://localhost:3000", "http://localhost:5173", "http://127.0.0.1:5500", "http://localhost:5500", "https://front-colficultor.onrender.com"]  # React/Vite/LiveServer
